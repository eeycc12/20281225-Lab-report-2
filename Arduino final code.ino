...
Encoder enc1(11, 2);  // create an encoder object for encoder 1
Encoder enc2(12, 3);  // create an encoder object for encoder 2
...
#define INa A3  // Channel A direction 
#define INb A2  // Channel A direction 
...
void setSteeringAngle(int servoAngle){
  servoAngle = constrain(servoAngle, 35, 135); // prevents the servo being set to 'impossible' angles
